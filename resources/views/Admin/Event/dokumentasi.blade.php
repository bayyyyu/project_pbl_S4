                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                ...
                                                @method('PUT')
                                                    ...
                                                    <div class="form-group">
                                                        <label for="">Foto / Video Dokumentasi</label>
                                                        <input type="file" class="form-control" name="foto_dokumentasi" accept="image/* , .mp4">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                            ...
                                            <div class="btn-group mb-2">
                                                ...
                                                <a href="{{ url('Admin/Event') }}" class="btn btn-danger float-right "> Batal </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
